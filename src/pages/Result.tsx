...
import { ExternalLink, Beaker, Heart, User, Sparkles, MapPin, Lightbulb } from 'lucide-react';
            ...
            <CardContent className="p-8 md:p-12 space-y-10">
              ...
              <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <div className="backdrop-blur-md bg-gradient-to-br from-secondary/20 to-secondary/10 border-2 border-secondary/30 rounded-3xl p-10 md:p-14 space-y-8 shadow-2xl">
                  ...
                  <Button 
                    className="w-full h-auto min-h-16 md:h-20 text-lg md:text-2xl font-bold transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-secondary/50 bg-secondary hover:bg-secondary/90 text-secondary-foreground rounded-2xl py-4"
                    size="lg"
                    asChild
                  >
                    <a 
