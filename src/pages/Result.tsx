    ...
    <div className="min-h-screen bg-background py-12 md:py-20">
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden md:block">
        <div className="relative">
          {showShareMenu && (
            <div className="absolute bottom-16 right-0 bg-background border border-border rounded-lg shadow-xl p-3 space-y-2 animate-fade-in will-change-[opacity,transform]">
              <Button
                onClick={handleTwitterShare}
                size="sm"
                className="w-full bg-black hover:bg-black/90 text-white justify-start"
              >
              ...
              <Button
                ...
                size="sm"
                className="w-full bg-[#25D366] hover:bg-[#25D366]/90 text-white justify-start"
              >
                <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <Button
                ...
                size="sm"
                className="w-full bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 text-white justify-start"
              >
                <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="space-y-6 animate-fade-in will-change-[opacity,transform]" style={{ animationDelay: '0.5s' }}>
                ...
                <div className="text-center pt-6 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
                    ...
                    <Button
                      onClick={handleFacebookShare}
                      className="w-full sm:w-auto bg-[#1877F2] hover:bg-[#1877F2]/90 text-white"
                      size="sm"
                    >
                      <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
