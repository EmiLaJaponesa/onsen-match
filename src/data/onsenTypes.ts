...
export const onsenResults: Record<OnsenType, OnsenResult> = {
    ...
    destinations: [
      {
        ...
        kanji: "万座温泉",
        location: "Gunma",
        description: "Famosa por su nivel del acidez; purificación intensa.",
      },
      {
        name: "Naruko Onsen",
        kanji: "鳴子温泉",
      ...
      {
        name: "Hakone Ashinoyu Onsen",
        kanji: "箱根芦之湯温泉",
        location: "Kanagawa",
        description: '"Fácil acceso desde Tokio, ambiente relajante en el bosque',
      },
    ],
  },
  carbonated: {
  ...
  simple: {
    ...
    destinations: [
      ...
      },
      {
        ...
        kanji: "下呂温泉",
        location: "Gifu",
        description: "Paseo en el bosque; relajación sin estímulos fuertes.",
      },
      {
        name: "Yufuin Onsen",
        kanji: "由布院温泉",
        location: "Oita",
        description: "Es uno del destino común para locales. Ambiente muy tradicional japonés.",
      },
    ],
  },
  ferruginous: {
    ...
    destinations: [
      ...
      },
      {
        ...
        kanji: "鉄輪温泉",
        location: "Oita",
        description: "Experiencia extraordinaria; uno de los mejores termales.",
      },
      {
        name: "Unzen Onsen",
        kanji: "雲仙温泉",
  ...
  radon: {
    ...
    destinations: [
      ...
      {
        name: "Kumanokawa Onsen",
        kanji: "熊の川温泉",
        location: "Saga",
        description: "Ambiente relajante; descanso sereno.",
      },
      {
        name: "Sanage Onsen",
        kanji: "猿投温泉",
